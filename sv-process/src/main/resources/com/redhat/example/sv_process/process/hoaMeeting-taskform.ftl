<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("outNewOrder");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid outNewOrder");
							myInputs[j].focus();
							return false;
						}
	...
	<div id="content">
		...
		<fieldset>
            <legend>Task Inputs</legend>
                            		...
                            		<div class="div_checkbox">
                              		<![CDATA[[users:|groups:executives]@[1m]]]>
                            		</div>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		<label for="name">outNewOrder</label>
                            		<div class="div_texbox">
                              		<input name="outNewOrder" type="text" class="textbox" id="outNewOrder" value="${outNewOrder}" />
                            		</div>
